 ...
 const handleFiltroFechaChange = (valor) => {
  ...
  return (
   ...
   <Select placeholder="Fechas" className='fechas-grafos' onChange={handleFiltroFechaChange} defaultValue={filtroFecha}>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Sentimientos-${filtroFecha}.html`} target="_blank">
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Atributos-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Clima%20social-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Continuidad%20y%20cambio-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Emociones%20Básicas%20(Plutchik)-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Preocupaciones-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Red%20motivacional%20del%20voto-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Voto%20Emocional%20y%20Racional-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
    ...
    <a href={`https://qsngrafos.vercel.app/modelos/11062016-M3/grafo_modelo-Preocupaciones%20-%20Ven-${filtroFecha}.html`} target="_blank">
    <div className=' cartaGrafo-modelos'>
